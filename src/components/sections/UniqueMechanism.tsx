    ...
    <SectionWrapper id="method" dark={true}>
      <div className="max-w-5xl mx-auto">
        <div className="text-center">
          ...
          <p className="font-sans text-lg text-cloud/50 mt-6 max-w-2xl mx-auto">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8">
          {COPY.uniqueMechanism.steps.map((step, i) => (
            <div key={i}>
              <div className="w-full h-px bg-cloud/[0.07] mb-6" />
              ...
              <p className="font-sans text-base text-cloud/45 mt-3 leading-relaxed">{step.body}</p>
            </div>
          ))}
        </div>
      </div>
